...
const Packages: React.FC = () => {
  ...
  const packages: PackageData[] = [
    ...
    },
    {
      ...
      emoji: '🥭',
      price: '$15,000',
      description: 'VIP Experience with premium features',
      features: [
        { text: 'Everything in The Evergreen, plus:' },
        { text: 'Fully custom design from scratch' },
        { text: 'Membership portal or course integration' },
        { text: 'Priority turnaround (2-4 weeks)' },
        { text: 'Custom copywriting for up to 5 pages' },
        { text: 'Advanced SEO & Google Analytics setup' },
        { text: '3 months of post-launch support' },
        { text: 'Exclusive "Mango Magic" Strategy Call' }
      ]
    }
  ];
